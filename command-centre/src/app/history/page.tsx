...
function StatusBadge({ status, hasError }: { status: string; hasError: boolean }) {
  if (hasError) {
    return (
      <span style={{ ...badgeBase, backgroundColor: "rgba(192, 64, 48, 0.1)", color: "var(--error)" }}>
  ...
  if (status === "review") {
    return (
      <span style={{ ...badgeBase, backgroundColor: "rgba(178, 93, 63, 0.1)", color: "var(--accent-terracotta-dark)" }}>
        <Clock size={12} /> Review
      </span>
    );
  }
  return (
    <span style={{ ...badgeBase, backgroundColor: "rgba(107, 142, 107, 0.1)", color: "var(--success)" }}>
...
function DigestIcon({ type }: { type: DigestEntry["type"] }) {
  ...
  switch (type) {
    case "text": return <MessageSquare size={13} color="var(--text-secondary)" style={s} />;
    case "tools": return <Wrench size={13} color="var(--text-tertiary)" style={s} />;
    case "question": return <Eye size={13} color="var(--accent-color)" style={s} />;
    case "reply": return <MessageSquare size={13} color="var(--accent-color)" style={s} />;
  }
}
  ...
  return (
    <select
      ...
      style={{
        ...
        backgroundColor: value ? "var(--accent-light)" : "var(--card-bg)",
        color: value ? "var(--accent-color)" : "var(--text-secondary)",
  ...
  switch (colId) {
    ...
    case "level":
      return task.cronJobSlug ? (
        <span style={{ ...badgeBase, backgroundColor: "rgba(59, 130, 246, 0.1)", color: "var(--info)" }}>
        ...
        <span
          style={{
            ...
            backgroundColor: "rgba(94, 94, 101, 0.08)", color: "var(--text-secondary)",
          }}
        >
            ...
            >
              ...
              {task.errorMessage && (
                ...
                >
                  ...
                  <span style={{ fontSize: 13, fontFamily: "var(--font-inter), Inter, sans-serif", color: "var(--error)", lineHeight: 1.4 }}>
                    {task.errorMessage}
                  </span>
                </div>
              )}
              ...
              {task.description && (
                <p
                  style={{
                    ...
                    color: "var(--text-secondary)", margin: "0 0 16px 0", lineHeight: 1.5,
                  }}
                >
                  {task.description}
                </p>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                    {digest.slice(-6).map((item, i) => (
                      <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 8, padding: "4px 0" }}>
                        <span style={{ fontSize: 10, fontFamily: "var(--font-space-grotesk), Space Grotesk, sans-serif", color: "var(--text-tertiary)", minWidth: 38, flexShrink: 0, marginTop: 2 }}>
                        ...
                        <span
                          style={{
                            fontSize: 13, fontFamily: "var(--font-inter), Inter, sans-serif",
                            color: item.type === "tools" ? "var(--text-secondary)" : item.type === "reply" ? "var(--accent-color)" : "var(--text-primary)",
                    ...
                    {digest.length > 6 && (
                      <div style={{ fontSize: 12, color: "var(--text-tertiary)", fontFamily: "var(--font-space-grotesk), Space Grotesk, sans-serif", paddingTop: 4 }}>
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                    {outputFiles.slice(0, 6).map((file) => (
                      ...
                      >
                        ...
                        {file.fileName}
                        <span style={{ fontSize: 10, color: "var(--text-tertiary)", backgroundColor: "var(--card-bg)", padding: "1px 5px", borderRadius: 3 }}>
                          .{file.extension}
                        </span>
                      </span>
                    ))}
                    {outputFiles.length > 6 && (
                      <span style={{ fontSize: 12, color: "var(--text-tertiary)", fontFamily: "var(--font-space-grotesk), Space Grotesk, sans-serif", padding: "5px 0", alignSelf: "center" }}>
              ...
              <button
                ...
                style={{
                  ...
                  backgroundColor: "var(--card-bg)", color: "var(--accent-color)",
                  fontFamily: "var(--font-space-grotesk), Space Grotesk, sans-serif",
                  fontSize: 13, fontWeight: 500, cursor: "pointer",
                  transition: "all 150ms ease",
                }}
                onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = "var(--accent-light)"; e.currentTarget.style.borderColor = "var(--accent-color)"; }}
                onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = "var(--card-bg)"; e.currentTarget.style.borderColor = "rgba(147, 69, 42, 0.2)"; }}
              >
...
function StatPill({ label, value }: { label: string; value: string }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <span style={{ fontSize: 11, fontFamily: "var(--font-space-grotesk), Space Grotesk, sans-serif", textTransform: "uppercase", letterSpacing: "0.06em", color: "var(--text-tertiary)", fontWeight: 600 }}>
        {label}
      </span>
      <span style={{ fontSize: 14, fontFamily: "var(--font-space-grotesk), Space Grotesk, sans-serif", fontWeight: 600, color: "var(--text-primary)" }}>
        {value}
      </span>
    </div>
  );
      ...
      <div style={{ width: "100%", boxSizing: "border-box" }}>
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <p
            style={{
              fontFamily: "var(--font-space-grotesk), Space Grotesk, sans-serif",
              fontSize: 13, color: "var(--text-tertiary)", marginTop: 6,
            }}
          >
        ...
        >
          <Filter size={14} color="var(--text-tertiary)" style={{ flexShrink: 0 }} />
        ...
        <div
          style={{
            backgroundColor: "var(--card-bg)", borderRadius: 12,
        ...
        >
          ...
          >
            <thead>
              <tr style={{ borderBottom: "1px solid var(--border-color-secondary)", backgroundColor: "var(--pane-bg)" }}>
                {columnOrder.map((colId) => {
                  const def = getColumnDef(colId);
                  const w = columnWidths[colId] || def.defaultWidth;
                  ...
                  return (
                    <th
                      ...
                      style={{
                        ...
                        color: isActive ? "var(--accent-color)" : "var(--text-secondary)",
                        position: "relative",
                        borderLeft: isDragTarget ? "2px solid var(--accent-terracotta-dark)" : "none",
                    ...
                    >
                      ...
                      >
                        <GripVertical size={10}                         color="var(--text-tertiary)" style={{ flexShrink: 0, cursor: "grab" }} />
                        {def.label}
                        {def.sortField && (
            ...
            <tbody>
              {isLoading && tasks.length === 0 ? (
                <tr>
                  <td colSpan={columnOrder.length} style={{ padding: 40, textAlign: "center", color: "var(--text-secondary)" }}>
                    Loading...
                  </td>
                </tr>
              ) : tasks.length === 0 ? (
...
const paginationBtnStyle: React.CSSProperties = {
  ...
  padding: "8px 16px", borderRadius: 8,
  border: "1px solid rgba(218, 193, 185, 0.3)",
  backgroundColor: "var(--card-bg)", color: "var(--text-secondary)", cursor: "pointer",
  fontFamily: "var(--font-space-grotesk), Space Grotesk, sans-serif",
