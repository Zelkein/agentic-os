    ...
    return (
      <AppShell title="GSD">
        <div style={{ padding: 24 }}>
          <div style={{ backgroundColor: "var(--error-bg)", padding: 16, borderRadius: 8 }}>
            <p style={{ fontFamily: "var(--font-inter), Inter, sans-serif", fontSize: 14, color: "var(--error)", margin: 0 }}>
            ...
            <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
              ...
              <div style={{ position: "relative", width: 48, height: 48 }}>
                <svg width="48" height="48" viewBox="0 0 48 48">
                  <circle cx="24" cy="24" r="20" fill="none" stroke="var(--skeleton-bg)" strokeWidth="4" />
                  <circle
                    cx="24"
                    cy="24"
                    r="20"
            ...
            <button
              ...
              style={{
                ...
                background: isSendingCommand
                  ? "var(--skeleton-bg)"
                  : "linear-gradient(135deg, var(--accent-color), var(--accent-terracotta-dark))",
                color: isSendingCommand ? "var(--text-secondary)" : "var(--card-bg)",
        ...
        >
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
              <span style={{ fontFamily: "var(--font-inter), Inter, sans-serif", fontSize: 16, fontWeight: 600, color: "var(--text-primary)" }}>
                Archive GSD Project
              </span>
              <button
                onClick={() => setShowArchiveConfirm(false)}
                style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: 4, border: "none", backgroundColor: "transparent", color: "var(--text-tertiary)", cursor: "pointer", borderRadius: 4 }}
              >
                <X size={16} />
              </button>
            </div>

            <p style={{ fontFamily: "var(--font-inter), Inter, sans-serif", fontSize: 14, color: "var(--text-secondary)", lineHeight: 1.6, margin: "0 0 8px" }}>
              This will archive the GSD project for <strong>{project.name}</strong>. Here&apos;s what happens:
            </p>

            <div style={{ display: "flex", flexDirection: "column", gap: 10, margin: "16px 0", padding: "16px 20px", backgroundColor: "var(--bg-secondary)", borderRadius: 10 }}>
            ...
            <p style={{ fontFamily: "var(--font-inter), Inter, sans-serif", fontSize: 13, color: "var(--text-tertiary)", lineHeight: 1.6, margin: "0 0 4px" }}>
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 20, justifyContent: "flex-end" }}>
              ...
              <button
                ...
                style={{
                  ...
                  backgroundColor: "var(--info)", color: "var(--card-bg)", cursor: archiving ? "not-allowed" : "pointer",
