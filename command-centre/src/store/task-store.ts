...
import type { Task, TaskLevel, TaskUpdateInput, OutputFile, LogEntry, AiModel } from "@/types/task";
...
interface TaskStore {
  ...
  createTask: (title: string, description: string | null, level: TaskLevel, projectSlug?: string | null, parentId?: string | null, permissionMode?: string, initialStatus?: string, clientId?: string | null, model?: AiModel | null) => Promise<string | null>;
...
export const useTaskStore = create<TaskStore>((set, get) => ({
  ...
  createTask: async (title: string, description: string | null, level: TaskLevel, projectSlug?: string | null, parentId?: string | null, permissionMode?: string, initialStatus?: string, clientIdOverride?: string | null, model?: AiModel | null) => {
