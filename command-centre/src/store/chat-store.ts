...
import type { AiModel, PermissionMode } from "@/types/task";
...
interface ChatState {
  ...
  sendMessage: (content: string, options?: { permissionMode?: PermissionMode; model?: AiModel | null; attachments?: ChatAttachment[] }) => Promise<void>;
