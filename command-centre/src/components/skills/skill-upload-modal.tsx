                ...
                <>
                  ...
                  >
                    <span style={{ display: "flex", alignItems: "center", gap: 4 }}>
                      <Link size={12} />
                      Reference URL
                      <span style={{ fontWeight: 400, textTransform: "none", letterSpacing: 0, color: "var(--text-tertiary)" }}>(optional)</span>
                    </span>
                  </label>
                  <input
                    type="url"
                ...
                <>
                  ...
                  >
                    {uploading ? (
                      ...
                      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
                        <FolderUp size={36} color={isDragging ? "var(--accent-color)" : "#DAC1B9"} />
                        <span
                          style={{
                            fontSize: 14,
