            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <button
                ...
                style={{
                  ...
                  border: "none",
                  borderRadius: 6,
                  backgroundColor: attachments.length > 0 ? "var(--accent-terracotta-light-bg)" : "transparent",
                  color: attachments.length > 0 ? "var(--accent-color)" : "var(--text-secondary)",
                ...
                onMouseEnter={(e) => {
                  if (!attachments.length) e.currentTarget.style.backgroundColor = "var(--bg-secondary)";
                }}
                onMouseLeave={(e) => {
                    ...
                    {(["task", "project", "gsd"] as TaskLevel[]).map((level) => (
                      <button
                        ...
                        style={{
                          ...
                          border: "none",
                          borderRadius: 5,
                          backgroundColor: levelOverride === level ? "var(--bg-secondary)" : "transparent",
                          color: "var(--text-primary)",
                          cursor: "pointer",
                          textAlign: "left",
                          fontWeight: 500,
              ...
              {levelOverride === "task" && (
                <label
                  ...
                  style={{
                    ...
                    fontWeight: 500,
                    fontFamily: "var(--font-space-grotesk), Space Grotesk, sans-serif",
                    color: planFirst ? "var(--accent-color)" : "var(--text-tertiary)",
                    cursor: "pointer",
                    userSelect: "none",
                  }}
                >
          ...
          >
            ...
            {([
              ...
              <div key={opt.level}>
                ...
                >
                  <opt.icon size={18} color="var(--accent-color)" style={{ flexShrink: 0, marginTop: 1 }} />
                  <div>
                    <div
                      style={{
                        fontSize: 13,
