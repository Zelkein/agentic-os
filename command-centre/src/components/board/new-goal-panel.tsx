      ...
      <div style={{ flex: 1, overflow: "auto", padding: "16px 20px 20px" }}>
        ...
        <div
          ...
          style={{
            ...
            border: isDraggingFiles ? "1px solid rgba(147, 69, 42, 0.45)" : "1px solid var(--border-color)",
            borderRadius: 10,
            overflow: "visible",
            position: "relative",
                ...
                {filteredFlags.map((opt, i) => (
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      borderRadius: 5,
                      backgroundColor: i === flagMenuIndex ? "var(--dropdown-bg)" : "transparent",
                      color: "var(--text-primary)",
                      cursor: "pointer",
            ...
            <div style={{ position: "relative", minWidth: 0, overflow: "hidden" }}>
              ...
              <textarea
                ...
                style={{
                  ...
                  fontSize: 14,
                  fontFamily: "var(--font-inter), Inter, sans-serif",
                  color: hasHighlight ? "transparent" : "var(--text-primary)",
        ...
        <button
          ...
          style={{
            ...
            color: isUploading ? "var(--text-tertiary)" : "var(--text-secondary)",
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 5,
            backgroundColor: "transparent",
            color: !draftId && !title.trim() && !message.trim() && attachments.length === 0 && pastedBlocks.length === 0 ? "var(--text-tertiary)" : "var(--text-secondary)",
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      borderRadius: 5,
                      backgroundColor: level === l ? "var(--dropdown-bg)" : "transparent",
                      color: "var(--text-primary)",
                      cursor: "pointer",
                      textAlign: "left" as const,
                      fontWeight: level === l ? 600 : 400,
                    }}
                    onMouseEnter={(e) => { if (level !== l) e.currentTarget.style.backgroundColor = "var(--pane-bg)"; }}
                    onMouseLeave={(e) => { if (level !== l) e.currentTarget.style.backgroundColor = "transparent"; }}
                  >
                    <div>{label}</div>
                    <div style={{ fontSize: 10, fontWeight: 400, color: "var(--text-tertiary)", marginTop: 1 }}>
                      {hint}
                    </div>
                  </button>
                );
          ...
          <div ref={clientMenuRef} style={{ position: "relative" }}>
            <button
              ...
              style={{
                ...
                borderRadius: 5,
                backgroundColor: "transparent",
                color: attachments.length > 0 ? "var(--text-tertiary)" : "var(--text-secondary)",
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    borderRadius: 5,
                    backgroundColor: selectedClientId === null ? "var(--dropdown-bg)" : "transparent",
                    color: "var(--text-primary)",
                    cursor: "pointer",
                    textAlign: "left" as const,
                    fontWeight: selectedClientId === null ? 600 : 400,
                  }}
                  onMouseEnter={(e) => { if (selectedClientId !== null) e.currentTarget.style.backgroundColor = "var(--pane-bg)"; }}
                ...
                {clients.map((c) => (
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      borderRadius: 5,
                      backgroundColor: selectedClientId === c.slug ? "var(--dropdown-bg)" : "transparent",
                      color: "var(--text-primary)",
                      cursor: "pointer",
                      textAlign: "left" as const,
                      fontWeight: selectedClientId === c.slug ? 600 : 400,
                    }}
                    onMouseEnter={(e) => { if (selectedClientId !== c.slug) e.currentTarget.style.backgroundColor = "var(--pane-bg)"; }}
        ...
        <button
          ...
          style={{
            ...
            background: canSubmit
              ...
              : "var(--skeleton-bg)",
            color: canSubmit ? "var(--card-bg)" : "var(--text-tertiary)",
            border: "none",
            borderRadius: 6,
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              {suggestions.map((s) => (
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.backgroundColor = "var(--pane-bg)";
                ...
                >
                  <span style={{ fontSize: 13, fontWeight: 600, fontFamily: "var(--font-epilogue), Epilogue, sans-serif", color: "var(--text-primary)" }}>
                    {s.title}
                  </span>
                  <span style={{ fontSize: 12, fontFamily: MONO, color: "var(--text-tertiary)" }}>
                    {s.desc}
                  </span>
                </button>
              ))}
