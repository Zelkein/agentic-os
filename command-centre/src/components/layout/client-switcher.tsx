    ...
    <div ref={containerRef} style={{ position: "relative", padding: collapsed ? "8px 0" : "8px 0" }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0 }}>
          <Globe size={16} style={{ color: "var(--text-secondary)", flexShrink: 0 }} />
          {!collapsed && (
            <span
              style={{
                display: "block",
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 6,
              border: "none",
              background: selectedClientId === null ? "var(--accent-terracotta-light-bg)" : "transparent",
              cursor: "pointer",
              fontFamily: "var(--font-inter), Inter, sans-serif",
              fontSize: 13,
              color: selectedClientId === null ? "var(--accent-terracotta-text)" : "var(--text-secondary)",
              transition: "background 150ms ease",
            }}
            onMouseEnter={(e) => {
              if (selectedClientId !== null) e.currentTarget.style.backgroundColor = "var(--bg-secondary)";
            }}
            onMouseLeave={(e) => {
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0, flex: 1 }}>
              <Globe size={16} style={{ color: selectedClientId === null ? "var(--accent-terracotta-text)" : "var(--text-secondary)" }} />
          ...
          {clients.map((client) => (
            <button
              ...
              style={{
                ...
                borderRadius: 6,
                border: "none",
                background: selectedClientId === client.slug ? "var(--accent-terracotta-light-bg)" : "transparent",
                cursor: "pointer",
                fontFamily: "var(--font-inter), Inter, sans-serif",
                fontSize: 13,
                color: selectedClientId === client.slug ? "var(--accent-terracotta-text)" : "var(--text-secondary)",
                transition: "background 150ms ease",
              }}
            onMouseEnter={(e) => {
              if (selectedClientId !== client.slug) e.currentTarget.style.backgroundColor = "var(--bg-secondary)";
            }}
            onMouseLeave={(e) => {
