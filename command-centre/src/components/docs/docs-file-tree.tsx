        ...
        <button
          ...
          style={{
            ...
            background: isSelected
              ? "var(--accent-terracotta-light-bg)"
              : isDragOver
              ? "rgba(147, 69, 42, 0.08)"
              : "transparent",
          ...
          onMouseEnter={(e) => {
            if (!isSelected && !isDragOver) e.currentTarget.style.background = "var(--bg-secondary)";
          }}
          onMouseLeave={(e) => {
        ...
        >
          {isDir ? (
            isExpanded ? (
              ...
              <Folder size={16} style={{ color: isDragOver ? "var(--accent-color)" : "var(--text-secondary)", flexShrink: 0 }} />
            )
          ) : (
            (() => {
  ...
  const renderSectionHeader = (section: SectionData, sectionIndex: number) => {
    ...
    return (
      <button
        ...
        onMouseEnter={(e) => {
          if (!isDragOverFolder) e.currentTarget.style.background = "var(--bg-secondary)";
        }}
        onMouseLeave={(e) => {
      ...
      >
        {isExpanded ? (
          ...
          <Folder size={16} style={{ color: isDragOverFolder ? "var(--accent-color)" : "var(--text-secondary)", flexShrink: 0 }} />
        )}
  ...
  if (!hasContent) {
    return (
      <div style={{ padding: 24, textAlign: "center" }}>
        ...
        <p style={{ fontFamily: "var(--font-inter), Inter, sans-serif", fontSize: 13, color: "var(--text-secondary)" }}>
    ...
    <div style={{ padding: "8px 0" }}>
      ...
      {clients.length > 0 && (
        <div style={{ marginTop: 8 }}>
          ...
          >
            <Users size={16} style={{ color: "var(--accent-color)", flexShrink: 0 }} />
