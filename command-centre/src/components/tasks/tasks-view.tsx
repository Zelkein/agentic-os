    ...
    >
      ...
      <button
        ...
        style={{
          ...
          borderRadius: 6,
          border: "none",
          backgroundColor: message.trim() ? "var(--accent-color)" : "var(--skeleton-bg)",
          color: message.trim() ? "var(--card-bg)" : "var(--text-tertiary)",
      ...
      {actionSummary && (
        <div
          style={{
            ...
            gap: 10,
            padding: "12px 16px",
            backgroundColor: task.errorMessage ? "var(--error-bg)" : "var(--card-bg-tertiary)",
            borderRadius: 8,
        ...
        >
          {task.errorMessage ? (
            <AlertCircle size={14} color="var(--error)" style={{ flexShrink: 0, marginTop: 2 }} />
          ) : (
            <Eye size={14} color="var(--warning)" style={{ flexShrink: 0, marginTop: 2 }} />
          )}
          <div
            style={{
              fontSize: 13,
              fontFamily: "var(--font-inter), Inter, sans-serif",
              color: task.errorMessage ? "var(--error)" : "var(--text-primary)",
              lineHeight: "20px",
            }}
          >
            {actionSummary}
            ...
            {recentEntries.map((entry) => (
              ...
              >
                ...
                <div
                  style={{
                    fontSize: 13,
                    color: entry.type === "user_reply" ? "var(--accent-color)" : entry.type === "question" ? "var(--warning)" : "var(--text-secondary)",
                    fontFamily: "var(--font-inter), Inter, sans-serif",
...
function DigestIcon({ type }: { type: "text" | "question" | "reply" }) {
  ...
  switch (type) {
    ...
    case "question": return <Eye size={13} color="var(--warning)" style={s} />;
      ...
      >
        ...
        <span
          style={{
            ...
            fontWeight: 500,
            fontFamily: "var(--font-space-grotesk), Space Grotesk, sans-serif",
            color: isWaitingForInput ? "var(--warning)" : isReview ? "var(--accent-terracotta-dark)" : isRunning ? "var(--accent-color)" : hasError ? "var(--error)" : "var(--success)",
            flexShrink: 0,
            whiteSpace: "nowrap",
          }}
        >
        ...
        {task.status === "review" && (
          <button
            ...
            onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = "var(--success)"; e.currentTarget.style.color = "var(--card-bg)"; }}
            onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = "rgba(107, 142, 107, 0.1)"; e.currentTarget.style.color = "var(--success)"; }}
          >
...
function ProjectGroupHeader({
  ...
  const accent = isGoalGroup ? "var(--accent-color)" : (LEVEL_ACCENT[level] ?? "var(--text-secondary)");
        ...
        <>
          ...
          {waitingTasks.length > 0 && (
            <div style={{ marginBottom: runningTasks.length > 0 ? 24 : 0 }}>
              <SectionHeader label="Waiting on you" count={waitingTasks.length} color="var(--warning)" />
          ...
          {runningTasks.length > 0 && (
            <div>
              <SectionHeader label="Running" count={runningTasks.length} color="var(--accent-color)" />
