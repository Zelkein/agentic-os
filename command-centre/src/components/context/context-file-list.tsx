...
const iconMap: Record<string, React.ReactNode> = {
  SOUL: <FileText size={18} style={{ color: "var(--accent-color)" }} />,
  USER: <FileText size={18} style={{ color: "var(--accent-color)" }} />,
  learnings: <FileText size={18} style={{ color: "var(--accent-color)" }} />,
};
...
function getIcon(name: string): React.ReactNode {
  ...
  return iconMap[base] || <FileText size={18} style={{ color: "var(--accent-color)" }} />;
}
  ...
  if (files.length === 0) {
    return (
      <div style={{ textAlign: "center", padding: "60px 20px" }}>
        <FileText
          size={48}
          style={{ color: "var(--text-secondary)", margin: "0 auto 16px", display: "block" }}
        />
        <h4
          style={{
          ...
          >
            ...
            >
              <button
                ...
                style={{
                  ...
                  padding: 2,
                  color: index === 0 ? "#D1D1D6" : "var(--text-secondary)",
                  display: "flex",
                  alignItems: "center",
              ...
              <button
                ...
                style={{
                  ...
                  padding: 2,
                  color: index === files.length - 1 ? "#D1D1D6" : "var(--text-secondary)",
                  display: "flex",
                  alignItems: "center",
                  transition: "color 150ms ease",
                }}
            ...
            <button
              ...
              style={{
                ...
                border: "none",
                borderRadius: "0.5rem",
                background: isSelected ? "var(--accent-terracotta-light-bg)" : "var(--card-bg)",
                cursor: "pointer",
                textAlign: "left",
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div
                  style={{
                    ...
                    fontWeight: 600,
                    fontSize: 14,
                    color: isSelected ? "var(--accent-terracotta-text)" : "var(--text-primary)",
                  }}
                >
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    background: isSelected ? "var(--accent-terracotta-light-bg)" : "transparent",
                    cursor: "pointer",
                    textAlign: "left",
                    fontFamily: "var(--font-inter), Inter, sans-serif",
                    fontSize: 13,
