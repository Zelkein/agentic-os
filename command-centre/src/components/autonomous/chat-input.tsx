        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 8,
              border: "none",
              backgroundColor: canSend ? "var(--accent-color)" : "rgba(147, 69, 42, 0.15)",
              color: canSend ? "var(--card-bg)" : "var(--text-tertiary)",
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              color: composer.isUploading || !scopeId ? "var(--text-tertiary)" : "var(--text-secondary)",
