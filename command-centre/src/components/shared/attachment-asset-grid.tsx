    ...
    >
      ...
      <span
        style={{
          ...
          lineHeight: 1.35,
          fontFamily: MONO,
          color: item.status === "failed" ? "var(--error)" : "#7B736E",
          overflow: "hidden",
...
function PdfAttachmentPreviewFrame({
  ...
  return <AttachmentPreviewFallback item={item} compact={compact} accentColor="var(--accent-color)" />;
}
...
export function AttachmentAssetCard({
  ...
  const accentColor = item.status === "failed" ? "var(--error)" : "var(--accent-color)";
      ...
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
          <span
            style={{
              ...
              fontWeight: 700,
              letterSpacing: "0.08em",
              color: item.status === "failed" ? "var(--error)" : "#6A6765",
              fontFamily: MONO,
              textTransform: "uppercase",
            }}
          >
          ...
          {onRemoveItem ? (
            <button
              ...
              style={{
                ...
                color: item.status === "failed" ? "var(--error)" : "#A39B95",
                cursor: "pointer",
                flexShrink: 0,
              }}
            >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
          ...
          >
            ...
            {item.status === "uploading" ? (
              <LoaderCircle size={13} style={{ color: "var(--accent-color)", animation: "spin 1s linear infinite" }} />
            ) : null}
