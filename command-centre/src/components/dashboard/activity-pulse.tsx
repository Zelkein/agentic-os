...
export function ActivityPulse({ weekStats, claudeUsage }: ActivityPulseProps) {
  ...
  const barColor = isHigh ? "var(--error)" : isMid ? "var(--warning)" : "var(--accent-color)";
  ...
  return (
    <div style={cardStyle}>
      ...
      {hasActivity ? (
            ...
            <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", marginBottom: 6 }}>
              ...
              {hasBudget ? (
                <span style={{
                  ...
                  fontSize: 20,
                  fontWeight: 600,
                  color: isHigh ? "var(--error)" : "var(--text-primary)",
                  lineHeight: 1,
                }}>
                  {todayPct}%
                </span>
        ...
        <p style={{ ...sectionLabelStyle, color: "var(--text-tertiary)", margin: 0 }}>
