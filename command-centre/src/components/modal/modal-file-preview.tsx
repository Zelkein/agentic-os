...
export function ModalFilePreview({
  ...
  const mainContent = (
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0, flex: 1 }}>
          <button
            ...
            onMouseEnter={(e) => { e.currentTarget.style.background = "var(--skeleton-bg)"; }}
            ...
            {breadcrumbSegments.map((seg, i) => (
              ...
              >
                {i > 0 && (
                  <ChevronRight
                    size={12}
                    style={{ color: "var(--text-tertiary)", flexShrink: 0, margin: "0 1px" }}
                  />
                )}
                {seg.isLast ? (
                  <span
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6, flexShrink: 0 }}>
          ...
          <button
            ...
            onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = "var(--skeleton-bg)"; }}
            onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = "var(--skeleton-bg)"; }}
          >
            <Download size={12} />
            Download
          </button>
      ...
      >
        {isLoading && (
          <div style={{ textAlign: "center", padding: 32, color: "var(--text-secondary)", fontSize: 14, fontFamily: "var(--font-inter), Inter, sans-serif" }}>
            Loading file...
          </div>
        )}

        {error && (
          <div style={{ textAlign: "center", padding: 32, color: "var(--error)", fontSize: 14, fontFamily: "var(--font-inter), Inter, sans-serif" }}>
            {error}
          </div>
        )}
