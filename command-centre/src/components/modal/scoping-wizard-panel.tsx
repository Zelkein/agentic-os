          ...
          {[1, 2, 3].map((n) => (
            <div
              ...
              style={{
                ...
                height: 3,
                borderRadius: 2,
                backgroundColor: step >= (n as Step) ? "var(--accent-color)" : "var(--skeleton-bg)",
...
function Step3Confirm({
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      >
        Creating project{" "}
        <strong style={{ color: "var(--accent-color)" }}>&ldquo;{projectName}&rdquo;</strong>
        {noSubtasks ? (
  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: 4,
        backgroundColor: "var(--card-bg)",
        color: disabled ? "#D1C7C2" : "var(--text-secondary)",
