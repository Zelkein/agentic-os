  ...
  return (
    ...
    >
      ...
      >
        {parts.map((p, i) =>
          p.kind === "tag" ? (
            <span key={i} style={{ color: "var(--accent-color)" }}>{p.text}</span>
          ) : p.kind === "command" ? (
...
export function ReplyInput({
  ...
  return (
    ...
    >
      {error && (
        <div style={{ fontSize: 12, color: "var(--error)", marginBottom: 6, fontFamily: "var(--font-space-grotesk), Space Grotesk, sans-serif" }}>
          {error}
        </div>
      )}
      <div
        style={{
          ...
          border: composer.isDragging ? "1px solid rgba(147, 69, 42, 0.45)" : "1px solid var(--border-color)",
          borderRadius: 10,
          overflow: "visible",
          position: "relative",
          ...
          <div style={{ position: "relative", minWidth: 0, overflow: "hidden" }}>
            ...
            <textarea
              ...
              style={{
                ...
                overflowWrap: "anywhere",
                wordBreak: "break-word",
                color: (composer.message.includes("@") || composer.message.includes("/")) ? "transparent" : "var(--text-primary)",
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 5,
              backgroundColor: "transparent",
              color: composer.isUploading ? "var(--text-tertiary)" : "var(--text-secondary)",
            ...
            style={{
              ...
              background:
                canSubmit && !isSending
                  ...
                  : "var(--skeleton-bg)",
              color: canSubmit && !isSending ? "var(--card-bg)" : "var(--text-secondary)",
