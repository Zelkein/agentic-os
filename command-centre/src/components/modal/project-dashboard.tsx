...
> = {
  backlog: { icon: Inbox, color: "var(--text-tertiary)", label: "Backlog" },
  queued: { icon: Clock, color: "var(--text-tertiary)", label: "Queued" },
  running: { icon: Loader2, color: "var(--accent-color)", label: "Running" },
  review: { icon: Eye, color: "var(--accent-terracotta-dark)", label: "Needs review" },
  done: { icon: CheckCircle2, color: "var(--success)", label: "Done" },
};
              ...
              {showSubtasksPopover && (
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        ...
                        style={{
                          ...
                          borderRadius: 5,
                          backgroundColor: backlogChildren.length === 0 ? "var(--bg-secondary)" : "rgba(147, 69, 42, 0.06)",
                          color: backlogChildren.length === 0 ? "var(--text-tertiary)" : "var(--accent-color)",
                          fontFamily: "var(--font-space-grotesk), Space Grotesk, sans-serif",
                          fontSize: 10,
                          fontWeight: 600,
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            backgroundColor: needs ? "var(--accent-light)" : "transparent",
                            transition: "background 80ms ease",
                          }}
                          onMouseEnter={(e) => {
                            if (executed) {
                              e.currentTarget.style.backgroundColor = needs ? "#FFEDE3" : "var(--pane-bg)";
                            }
                          }}
                          onMouseLeave={(e) => {
                            e.currentTarget.style.backgroundColor = needs ? "var(--accent-light)" : "transparent";
                          }}
                        >
                          <button
                            type="button"
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                              <span
                                style={{
                                  ...
                                  fontWeight: 500,
                                  fontFamily: "var(--font-inter), Inter, sans-serif",
                                  color: executed ? "var(--text-primary)" : "var(--text-tertiary)",
                                  overflow: "hidden",
                                  textOverflow: "ellipsis",
                                  whiteSpace: "nowrap",
                                ...
                                <>
                                  ...
                                  >
                                    {availablePanes.length <= 1 ? (
                                      ...
                                      >
                                        <Home size={11} style={{ color: "var(--accent-color)", flexShrink: 0 }} />
                                        <span style={{
                                          fontSize: 11,
                                          fontFamily: "var(--font-inter), Inter, sans-serif",
                                      ...
                                      <>
                                        ...
                                        {availablePanes.map((pane) => (
                                          ...
                                          >
                                            {pane.isMain
                                              ? <Home size={10} style={{ color: "var(--accent-color)", flexShrink: 0 }} />
                                              : <MessageSquare size={10} style={{ color: "var(--text-tertiary)", flexShrink: 0 }} />}
                                            <span style={{
                                              fontSize: 11,
                                              fontFamily: "var(--font-inter), Inter, sans-serif",
                                              color: "var(--text-primary)",
                                        ...
                                        <div style={{ height: 1, backgroundColor: "var(--skeleton-bg)", margin: "2px 0" }} />
                                      </>
                                    )}
                                    <button
                                      onClick={(e) => {
                                    ...
                                    >
                                      <MessageSquare size={11} style={{ color: "var(--accent-color)", flexShrink: 0 }} />
                                      <span style={{
                                        fontSize: 11,
                                        fontFamily: "var(--font-inter), Inter, sans-serif",
                                        color: "var(--text-primary)",
                          ...
                          {executed && (
                            <ChevronRight size={12} style={{ color: "var(--text-tertiary)", flexShrink: 0, marginTop: 3 }} />
                          )}
                        </div>
                      );
                    })}
                    ...
                    {/* Add subtask row */}
                    <div style={{ padding: "6px 12px", borderTop: "1px solid var(--border-color)" }}>
                      {showAddSubtask ? (
                          ...
                          <button
                            ...
                            style={{
                              ...
                              background: newSubtaskTitle.trim() && !creatingSubtask
                                ...
                                : "var(--skeleton-bg)",
                              color: newSubtaskTitle.trim() && !creatingSubtask ? "var(--text-primary)" : "var(--text-tertiary)",
                              fontSize: 11,
                              fontWeight: 600,
                        ...
                        <button
                          ...
                          onMouseEnter={(e) => {
                            if (task.projectSlug) e.currentTarget.style.color = "var(--accent-color)";
                          }}
                          onMouseLeave={(e) => {
