        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              color: layout === "horizontal" ? "var(--accent-color)" : "var(--text-tertiary)",
            }}
          >
            <Columns2 size={12} />
          </button>
          <button
            ...
            style={{
              ...
              color: layout === "grid" ? "var(--accent-color)" : "var(--text-tertiary)",
            }}
          >
          ...
          {visiblePanes.length <= 2 ? (
            ...
            visiblePanes.map((pane, idx) => (
              <React.Fragment key={pane.id}>
                {idx > 0 && <div style={{ height: 1, backgroundColor: "var(--resize-handle)", flexShrink: 0 }} />}
            ...
            <>
              ...
              <div style={{ height: 1, backgroundColor: "var(--resize-handle)", flexShrink: 0 }} />
              <div style={{ flex: 1, display: "flex", overflow: "hidden", minHeight: 0 }}>
...
function PaneWrapper({
  ...
  return (
    <div style={{
      ...
      flexDirection: "column",
      overflow: "hidden",
      borderLeft: borderLeft ? "1px solid var(--border-color)" : undefined,
    }}>
      {/* Name header */}
      <div
        onClick={onFocus}
        style={{
          ...
          gap: 6,
          padding: "0 10px",
          backgroundColor: isFocused ? "rgba(147, 69, 42, 0.03)" : "var(--pane-bg)",
          borderBottom: isFocused ? "2px solid #93452A" : "1px solid var(--border-color)",
          flexShrink: 0,
          cursor: "pointer",
        }}
      >
        {pane.type === "terminal" && (
          <Terminal size={11} style={{ color: "var(--success)", flexShrink: 0 }} />
        )}
        <span style={{
          flex: 1,
          fontSize: 11,
