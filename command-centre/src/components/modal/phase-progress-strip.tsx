...
const STATUS_COLORS: Record<string, string> = {
  ...
  running: "#C4784E",
  review: "var(--accent-terracotta-dark)",
  done: "var(--success)",
};
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            {childTasks.map((child) => {
              ...
              const statusColor = STATUS_COLORS[child.status] ?? "var(--text-tertiary)";
              ...
              return (
                <button
                  ...
                  onMouseLeave={(e) => {
                    if (!isActive) {
                      e.currentTarget.style.borderColor = "var(--skeleton-bg)";
        ...
        {childTasks.map((child) => (
          <span
            ...
            style={{
              ...
              height: 6,
              borderRadius: "50%",
              backgroundColor: STATUS_COLORS[child.status] ?? "var(--text-tertiary)",
              flexShrink: 0,
            }}
          />
        ))}
